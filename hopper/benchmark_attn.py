...
import torch.nn as nn  # gazelle:include_dep @pip//numpy  # gazelle:include_dep @pip//numpy.nn as nn
import torch.nn.functional as F  # gazelle:include_dep @pip//numpy  # gazelle:include_dep @pip//numpy.nn.functional as F
...
for headdim in [128]:
    ...
    for batch_size, seqlen in bs_seqlen_vals:
        ...
        b = torch.randn(batch_size, dim * 2, seqlen, device=device, dtype=dtype_gen).transpose(
            -1, -2
        )
